...
// FakeResolver is a test double (test scope only; not part of the package API) that returns predetermined values without
...
func (f *FakeResolver) Toplevel(dir string) (string, bool, error) {
...
func (f *FakeResolver) RemoteURL(root string) (string, bool, error) {
...
func TestRealGitResolverHeadCommitReturnsExactHeadInCommonRepoStates(t *testing.T) {
	...
	assertHeadCommit(t, SystemGit{}, root, first)
	...
	assertHeadCommit(t, SystemGit{}, linkedRoot, first)
	...
	assertHeadCommit(t, SystemGit{}, submoduleRoot, submoduleHead)
}
...
func TestRealGitResolverHeadCommitReturnsExactHeadDuringMergeState(t *testing.T) {
	...
	assertHeadCommit(t, SystemGit{}, root, main)
}
...
func TestRealGitResolverHeadCommitReturnsExactHeadDuringRebaseState(t *testing.T) {
	...
	assertHeadCommit(t, SystemGit{}, root, want)
}
...
func assertHeadCommit(t *testing.T, resolver Resolver, root, want string) {
	t.Helper()
